...
class Application(tk.Frame):
	...
	def draw_controls_frame(self):
		...
		self.speak_btn = tk.Button(self.controls_frame, image=speakoff_icon, bg='#252525',relief=tk.FLAT, command=self.speaker_toggle)
	...
	def open_file(self):																		#For Opening PDF
	...
	def display_page(self):																		#Page Display
	...
	'''def next_page2(self, event=None):
		# turn over to the next page
		if self.fileisOpen:
			if self.speaker_on:
				engine.endLoop()
